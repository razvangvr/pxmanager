package org.eclipse.ui.articles.treeviewer;
...
import cbg.article.treeviewer.ui.BoardgameFilter;
import cbg.article.treeviewer.ui.BookBoxBoardSorter;
import cbg.article.treeviewer.ui.MovingBoxContentProvider;
import cbg.article.treeviewer.ui.MovingBoxLabelProvider;
import cbg.article.treeviewer.ui.NoArticleSorter;
import cbg.article.treeviewer.ui.ThreeItemFilter;

public class View extends ViewPart {
	public static final String ID = "org.eclipse.ui.articles.treeviewer.view";
	...
	public void createPartControl(Composite parent) {
		 ...
		 * instead of a label so you can copy-paste out of it.
		 */
	...
	protected void createActions() {
		...
		addBookAction.setImageDescriptor(Activator
				.getImageDescriptor("icons/newBook.gif"));
