 ...
 */
  public class ProfilDAO extends GenericDAO{
    private static List elements = null;
   	...
   	private static final String INSERT_SQL = "INSERT INTO profil ( den) " +
			"VALUES ( ?)";

	private static final String UPDATE_SQL = "UPDATE profil SET  den=? WHERE " +
			" id=? ";

	private static final String SELECT_SQL = "SELECT * FROM profil";

	private static final String SELECT_BY_PK_SQL = "SELECT * FROM profil WHERE " +
			" id=? ";

    private static final String DELETE = "DELETE FROM profil WHERE " +
            " id=? ";
//    int[] a = new int[23];
   ...
   /* private static final String SELECT_LOGIN_SQL = "SELECT * FROM elev where username=? and userpassword=? ";  */
    ...
    private static final String COUNT_SQL = "SELECT count(*) FROM profil";


    private static final String DELETE_BY_PK_SQL = "DELETE FROM profil WHERE " +
            " id=? ";
