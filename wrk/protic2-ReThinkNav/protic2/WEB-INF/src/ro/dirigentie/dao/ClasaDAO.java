 ...
 */
  public class ClasaDAO extends GenericDAO{
    private static List elements = null;

   	private static final String INSERT_SQL = "INSERT INTO clasa ( id, den, id_an, id_profil, id_specializare) " +
			"VALUES ( ?,?,?,?,?)";

	private static final String UPDATE_SQL = "UPDATE clasa SET  den=?, id_an=?, id_profil=?, id_specializare=? WHERE " +
			" id=? ";

	private static final String SELECT_SQL = "SELECT * FROM clasa";

	private static final String SELECT_BY_PK_SQL = "SELECT * FROM clasa WHERE " +
			" id=? ";
    private static final String SELECT_BY_AN_SQL = "SELECT * FROM clasa WHERE " +
			" id_an=? ";

    private static final String DELETE = "DELETE FROM clasa WHERE " +
            " id=? ";
//    int[] a = new int[23];
   ...
   /* private static final String SELECT_LOGIN_SQL = "SELECT * FROM elev where username=? and userpassword=? ";  */
    ...
    private static final String COUNT_SQL = "SELECT count(*) FROM clasa";


    private static final String DELETE_BY_PK_SQL = "DELETE FROM clasa WHERE " +
            " id=? ";
