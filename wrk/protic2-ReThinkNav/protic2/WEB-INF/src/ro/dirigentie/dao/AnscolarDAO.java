 ...
 */
  public class AnscolarDAO extends GenericDAO{
    private static List elements = null;

   	private static final String INSERT_SQL = "INSERT INTO anscolar ( den) " +
			"VALUES ( ?)";

	private static final String UPDATE_SQL = "UPDATE anscolar SET  den=? WHERE " +
			" id=? ";

	private static final String SELECT_SQL = "SELECT * FROM anscolar";

	private static final String SELECT_BY_PK_SQL = "SELECT * FROM anscolar WHERE " +
			" id=? ";

    private static final String DELETE = "DELETE FROM anscolar WHERE " +
            " id=? ";
//    int[] a = new int[23];
   ...
   /* private static final String SELECT_LOGIN_SQL = "SELECT * FROM elev where username=? and userpassword=? ";  */
    ...
    private static final String COUNT_SQL = "SELECT count(*) FROM anscolar";


    private static final String DELETE_BY_PK_SQL = "DELETE FROM anscolar WHERE " +
            " id=? ";
