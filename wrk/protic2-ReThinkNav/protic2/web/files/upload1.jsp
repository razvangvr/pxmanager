...
<table class="titlu">
    <tr><td valign=top>
        <jsp:include page="../menures.jsp" flush="true"/>
    </td>
    <td width=10%>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<BR>
    </td>
    ...
    <BR><BR>
        <FORM name="form2" action="upload1.jsp" method="POST" name="UploadForm" enctype="multipart/form-data" onsubmit="return validateForm();">
