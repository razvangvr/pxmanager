...
<h2 align=center>Editare Utilizatori</h2>
...
<table width="489" border="0" cellpadding="0">
  <tr>
    <td colspan="2" align="left" ><input type="submit" name="Save" value="Save">
...
<%--    <input name="prPDCode" type="text" size="20" maxlength="15" value="<c:out value="${bean.prPDCode}"/>">--%>
  ...
  <tr>
   ...
   <tr>
    ...
    <td width="282">
    <select name=grupa>
    <option name="1" type="text" value="1" <%//=ua.getGrupa()== 1 ?"Selected":""%>>1</option>
    </select>
    </td>
   </tr-->
</table>
