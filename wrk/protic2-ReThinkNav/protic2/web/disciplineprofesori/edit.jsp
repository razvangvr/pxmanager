...
<h2 align=center>Modificare discipline profesor <%=((ProfesorBean)new ProfesorDAO().getByPK(request.getParameter("id_profesor")).get(0)).getNume()%></h2>
...
<table width="400" border="0" cellpadding="0">
  <tr>
    ...
    <input type="button" name="cancel" value="Inapoi" onClick="document.location='list.jsp?id_profesor=<%=request.getParameter("id_profesor")%>'">
    <input type="hidden" name="id_profesor" value="<%=request.getParameter("id_profesor")%>">
    </td>
  </tr>
  <tr>
    <td colspan="2" align="left" >
