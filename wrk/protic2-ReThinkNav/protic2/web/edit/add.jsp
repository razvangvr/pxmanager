...
<table width="400" border="0" cellpadding="0">
  ...
  <tr>
    <td width="201">Grupa : </td>
    <td width="282">
    <select name="grupa">
    <option name="1" type="text" value="4">1</option>
    <option name="2" type="text" value="2">2</option>
    <option name="3" type="text" value="3">3</option>
    <option name="4" type="text" value="4">4</option>
    <option name="5" type="text" value="5">5</option>
    <option name="6" type="text" value="6">6</option>
    </select>
    </td>
   </tr>
  </table>
