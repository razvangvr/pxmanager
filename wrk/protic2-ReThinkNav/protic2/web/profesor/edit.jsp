...
<h2 align=center>Editare Profesor</h2>
...
<table width="400" border="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="282">
    <input name="num" type="text" size="30" value="<%=b.getNume()!=null?b.getNume():""%>">
    </td>
  </tr>
   <tr>
...
<%--        </td>--%>
<%--    <td width="201">--%>
<%--           <input type="button" name="parinti" value="Discipline profesor"--%>
<%--            onClick="document.location='../disciplineprofesori/list.jsp?id_profesor=<%=request.getParameter("id")%>'" >--%>
<%--</td></tr>--%>
</table>
